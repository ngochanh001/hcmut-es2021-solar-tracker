int32_t angle_yoz, pulse_yoz;//goc tam pin voi phap tuyen trai dat
int32_t angle_current_yoz = 0;
int32_t angle_xoy, pulse_xoy;//goc huong cua tam pin voi huong bac
int32_t angle_current_xoy = 0;
